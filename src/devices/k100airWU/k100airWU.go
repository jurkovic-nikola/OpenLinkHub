...
// Package: K100 AIR USB
// This is the primary package for K100 AIR USB.
...
var (
	...
	lockLedIndex            = 342
	rgbProfileUpgrade       = []string{"tlk", "tlr", "spiralrainbow", "rainbowwave", "rain", "visor", "colorwave", "gradient"}
	rgbModes                = []string{
		"circle",
		"circleshift",
		"colorpulse",
