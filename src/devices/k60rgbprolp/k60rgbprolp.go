...
// Package: K60 PRO RGB Low Profile
...
var (
	...
	keyboardKey             = "k60rgbprolp-default"
	defaultLayout           = "k60rgbprolp-default-US"
	KeyAssignment           = 123
...
func (d *Device) createDevice() {
	d.instance = &common.Device{
		ProductType: common.ProductTypeK60RgbProLp,
		Product:     d.Product,
		Serial:      d.Serial,
		Firmware:    d.Firmware,
