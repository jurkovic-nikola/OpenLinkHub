...
// This is the primary package for CORSAIR HARPOON RGB WIRELESS Gaming Mouse
...
func (d *Device) TriggerKeyAssignment(value byte, serial string) {
	if value == 0 {
		d.PressLoop = false
	}
		...
		if val.ActionHold {
			...
			go func() {
				for {
					...
					case 1, 3:
						inputmanager.InputControl(val.ActionCommand, serial)
						break
					case 2:
						d.ModifyDpi()
						break
